...
class _DrafitingWidgetState extends State<DrafitingWidget> {
                              ...
                              _inProgressBoardside
                                  ...
                                  : InkWell(
                                      onTap: () async {
                                        ...
                                        await DockingInterface.patchDocking(
                                            docking["docking_id"], {
                                          "boardside_id":
                                              docking["boardside_id"] == 1
                                                  ? 2
                                                  : 1
                                        });
                                        await docking$
                            ...
                            : ElevatedButton(
                                ...
                                onPressed: _enableSave()
                                    ? (() async {
                                        ...
                                        await DockingInterface.postDrafting(
                                            widget.berth.dockingId, {
                                          'docking_id': widget.berth.dockingId,
                                          'assign_id': 1,
                                          't': _dateTime?.toIso8601String(),
                                          'draft': double.parse(
                                              _draftController.text.toString()),
                                          'pos': EnumToString.convertToString(
                                              _position),
                                          'stage': EnumToString.convertToString(
                                              _stage),
  ...
  bool _enableSave() {
    return _draftController.text.isNotEmpty &&
  ...
  Future<void> _showDeleteDialog(int draftingId, int dockingId) async {
    return showDialog<void>(
      context: context,
      barrierDismissible: false,
      builder: (BuildContext context) {
          ...
          actions: <Widget>[
            ...
            TextButton(
              ...
              onPressed: () async {
                ...
                await DockingInterface.deleteDrafting(
                    widget.berth.dockingId, draftingId);
